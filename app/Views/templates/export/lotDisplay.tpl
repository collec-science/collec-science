        ...
        <div class="tab-content" id="tabContent">
                    ...
                    <div class="row">
                        <table class="table table-bordered table-hover datatable display" data-order='[[1,"desc"]]'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="center">
                                        <a href="exportChange?export_id={$export.export_id}&lot_id={$export.lot_id}">
                                    ...
                                    <td class="center">
                                        <a href="exportExec?export_id={$export.export_id}&lot_id={$export.lot_id}">
            ...
            <div class="tab-pane fade" id="navcols" role="tabpanel" aria-labelledby="tabcols">
                <form action="lotDeleteSamples" method="post">
                    ...
                    <div class="row">
                        ...
                        <table class="table table-bordered table-hover datatable display" data-order='[[1,"asc"]]'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="center">
                                        <input type="checkbox" class="checkUid form-check-input" name="samples[]" value="{$sample.sample_id}">
                                    </td>
                                    <td class="center">
                    ...
                    <div class="row form-horizontal d-flex justify-content-center">
