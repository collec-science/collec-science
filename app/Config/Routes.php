...
$routes->add('riskList', 'Risk::list');
$routes->add('riskChange', 'Risk::change');
$routes->post('riskWrite', 'Risk::write');
$routes->post('riskDelete', 'Risk::delete');
$routes->add('productList', 'Product::list');
$routes->add('productChange', 'Product::change');
$routes->post('productWrite', 'Product::write');
$routes->post('productDelete', 'Product::delete');
...
$routes->post('containersLending', 'Container::lendingMulti');
$routes->post('containersExit', 'Container::exitMulti');
$routes->post('containersDelete', 'Container::deleteMulti');
$routes->post('containersAddEvent', 'Container::addMultiEvent');
$routes->post('containersSetStatus', 'Container::setStatus');
$routes->post('containersEntry', 'Container::entryMulti');
$routes->post('containersSetTrashed', 'ObjectController::setTrashed/container');
$routes->post('containersSetReferent', 'Container::referentMulti');
$routes->post('containersSetCollection', 'Container::setCollection');
$routes->add('containerVerifyCyclic', 'Container::verifyCyclic');
$routes->post('containerVerifyCyclicExec', 'Container::verifyCyclicExec');
...
$routes->add('containereventDuplicate', 'Event::duplicate/container');
$routes->add('sampleeventDuplicate', 'Event::duplicate/sample');
...
$routes->add("collectionDisplay", "Collection::display");
$routes->add('collectionGet', 'Collection::getAjax');
$routes->cli('collectionsGenerateMail', 'CollectionsGenerateMail::index');
$routes->add('collectionsSendMail', 'CollectionsGenerateMail::manual');
$routes->post('collectionImport', 'Collection::import');
...
$routes->post('collectiondocumentWrite', 'Document::write/collection');
$routes->add('collectiondocumentDelete', 'Document::delete/collection');
...
$routes->add("metadataRename", "Metadata::rename");
