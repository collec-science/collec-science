            ...
            <form class="form-horizontal" id="template" action="importTemplateGenerate" method="post">
                <fieldset id="containersFieldset">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <table class="col-11">
                                <tr>
                                    <td><label for="cf1" class="form-check-label">{t}Rangement du contenant dans un autre contenant :{/t}</label></td>
                                    <td class="center"><input type="checkbox" id="cf1" class="containers form-check-input" name="containerFields[]" value="containerLocation"></td>
                                </tr>
                                <tr>
                                    <td><label for="cf2" class="form-check-label">{t}Commentaire :{/t}</label>
                                    </td>
                                    <td class="center"><input type="checkbox" id="cf2" class="containers form-check-input" name="containerFields[]" value="container_comment"></td>
                                </tr>
                                <tr>
                                    <td><label for="cf3" class="form-check-label">{t}UUID connu :{/t}</label></td>
                                    <td class="center"><input type="checkbox" id="cf3" class="containers form-check-input" name="containerFields[]" value="container_uuid"></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                ...
                <fieldset id="samplesFieldset">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <select id="sampleTypes" class="samples form-select" name="sampleTypes[]" multiple title="{t}Vous pouvez sélectionner plusieurs éléments avec ctrl + clic{/t}">
                            </select>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <table class="col-11">
                                <tr>
                                    <td><label for="sf1" class="form-check-label">{t}Date d'expiration de l'échantillon :{/t}</label></td>
                                    <td class="center"><input type="checkbox" id="sf1" class="samples form-check-input" name="sampleFields[]" value="expiration_date"></td>
                                </tr>
                                <tr>
                                    <td><label for="sf2" class="form-check-label">{t}Identifiant dans la base de données d'origine :{/t}</label></td>
                                    <td class="center"><input type="checkbox" id="sf2" class="samples form-check-input" name="sampleFields[]" value="dbuid_origin"></td>
                                </tr>
                                <tr>
                                    <td><label for="sf3" class="form-check-label">{t}Rangement de l'échantillon dans un contenant :{/t}</label></td>
                                    <td class="center"><input type="checkbox" id="sf3" class="samples form-check-input" name="sampleFields[]" value="sampleLocation"></td>
                                </tr>
                                <tr>
                                    <td><label for="sf4" class="form-check-label">{t}Échantillon dérivé (ajout du parent) :{/t}</label></td>
                                    <td class="center"><input type="checkbox" id="sf4" class="samples form-check-input" name="sampleFields[]" value="sample_parent_identifier"></td>
                                </tr>
                                <tr>
                                    <td><label for="sf5" class="form-check-label">{t}Échantillon composé (plusieurs parents) :{/t}</label></td>
                                    <td class="center"><input type="checkbox" id="sf5" class="samples form-check-input" name="sampleFields[]" value="sampleComposite"></td>
                                </tr>
                                <tr>
                                    <td><label for="sf6" class="form-check-label">{t}Localisation GPS :{/t}</label></td>
                                    <td class="center"><input type="checkbox" id="sf6" class="samples form-check-input" name="sampleFields[]" value="sampleGps"></td>
                                </tr>
                                <tr>
                                    <td><label for="sf7" class="form-check-label">{t}UUID connu :{/t}</label></td>
                                    <td class="center"><input type="checkbox" id="sf7" class="samples form-check-input" name="sampleFields[]" value="sample_uuid"></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                ...
                <fieldset id="identifiers">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-8">
                            <select id="identifiers" name="identifiers[]" class="form-select" multiple title="{t}Vous pouvez sélectionner plusieurs éléments avec ctrl + clic{/t}">
            ...
            <ul>
                ...
                <li>{t}Pour importer des échantillons :{/t}
                    <ul>
                        ...
                        <li><b>composite_multiple_value</b> : {t}quantité prélevée dans chaque parent pour créer l'échantillon composé (champ obligatoire si création d'un échantillon composé). La quantité doit être identique pour chaque parent{/t}</li>
