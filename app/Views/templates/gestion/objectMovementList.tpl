...
<table id="movementList" class="table table-bordered table-hover datatable display" data-order='[[0,"desc"]]'>
	<thead>
		<tr>
			<th>{t}Date{/t}</th>
			<th>{t}Type{/t}</th>
	...
	<tbody>
		...
		<tr>
			...
			<td class="textareaDisplay">{$movements[lst].movement_comment}</td>
			<td>
				{$movements[lst].login}
			</td>
		</tr>
