...
<div class="row">
    <a href="index.php?module=lotList"><img src="display/images/list.png" height="25">
            ...
            <div class="tab-pane active in" id="navgeneral" role="tabpanel" aria-labelledby="tabgeneral">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <a href="index.php?module=exportChange&export_id=0&lot_id={$data.lot_id}">
                                {t}Nouvel export...{/t}</a>
                        </div>
                        <div class="row">
                            <table class="table table-bordered table-hover datatable" data-order='[[1,"desc"]]'>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="center">
                                            <a
                                                href="index.php?module=exportChange&export_id={$export.export_id}&lot_id={$export.lot_id}">
                                        ...
                                        <td class="center">
                                            <a
                                                href="index.php?module=exportExec&export_id={$export.export_id}&lot_id={$export.lot_id}">
