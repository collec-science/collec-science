		...
		<div class="row">
			<div class="col-md-6 form-horizontal">
				...
				<div class="event" hidden>
					...
					<div class="row mb-6 ">
						<label for="eventsType" class="form-label col-md-4"><span class="red">*</span> {t}Type d'événement :{/t}</label>
						<div class="col-md-8">
				...
				<div class="entry" hidden>
					<div class="row mb-6 ">
						<label for="container_uidChange" class="form-label col-md-4"><span class="red">*</span> {t}UID du contenant :{/t}</label>
						<div class="col-md-8">
