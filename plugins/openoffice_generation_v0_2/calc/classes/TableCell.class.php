...
class TableCell extends XMLElement {
	...
	/**
	 * @access 	protected
	 * @var 	integer			$decimal				Le nombre de décimal pour un nombre
	 */
	protected $decimal;
	...
	/**
	 * Fonction qui set le nombre de décimales
	 *
	 * @access 	public
	 * @param 	integer			$decimal				Le nombre de décimales
	 * @return 	void
	 */
	...
	/**
	 * Fonction qui get le nombre de décimales
	 *
	 * @access 	public
	 * @return 	integer									Le nombre de décimales
	 */
