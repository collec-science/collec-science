<a href="index.php?module=campaignList"><img src="display/images/list.png" height="25">{t}Retour à la liste des campagnes{/t}</a>
&nbsp;
<a href="index.php?module=campaignDisplay&campaign_id={$data.campaign_id}"><img src="display/images/display.png" height="25">{t}Retour au détail de la campagne{/t}</a>
