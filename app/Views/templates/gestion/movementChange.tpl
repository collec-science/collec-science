	...
	<div class="row">
		<div class="col-lg-6">
			<form class="form-horizontal " id="movement{$moduleParent}Form" method="post" action="movement{$moduleParent}Write">
				...
				<input type="hidden" id="uid" name="uid" value="{$data.uid}" readonly>
				<div class="row">
					<label class="form-label col-4">{t}Objet :{/t}</label>
					<div class="col-8">{$data.uid}&nbsp;{$object.identifier}</div>
				</div>
				...
				<fieldset>
					...
					<div class="row">
						...
						<div class="col-8">
							<input id="container_uid" name="container_uid" value="{$data.container_uid}" type="number" class="form-control slotFull" autofocus>
						</div>
					</div>
					<div class="row">
				...
				<fieldset>
					...
					<div class="row">
						...
						<div class="col-8">
							<input id="line_number" name="line_number" value="{$data.line_number}" class="form-control nombre slotFull" title="{t}N° de la ligne de rangement dans le contenant{/t}">
						</div>
					</div>
					<div class="row">
						<label for="column_number" class="form-label col-4">{t}N° de colonne :{/t}</label>
						<div class="col-8">
							<input id="column_number" name="column_number" value="{$data.column_number}" class="form-control nombre slotFull" title="{t}N° de la colonne de rangement dans le contenant{/t}">
						</div>
					</div>
					{/if}
