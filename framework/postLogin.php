...
if ($_SESSION["droits"][$APPLI_release_right_minimal] == 1) {
     ...
     */
    include_once "framework/utils/getLastRelease.php";
    if (!empty($APPLI_release_url)) {
        $lastRelease = getLastRelease($APPLI_release_url, $APPLI_release_url_tag, $APPLI_release_url_date, $APPLI_release_user_agent);
