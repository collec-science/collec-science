      ...
      <div class="col-md-6">
            ...
            <form class="form-horizontal " id="referentForm" method="post" action="referentWrite">
                  ...
                  <div class="form-group">
                        <label for="referentName" class="control-label col-md-4"><span class="red">*</span>
                              {t}Nom :{/t}</label>
                        <div class="col-md-8">
                  ...
                  <div class="form-group">
                        <label for="referent_organization" class="control-label col-md-4">
                              {t}Organisme :{/t}</label>
                        <div class="col-md-8">
                  ...
                  <div class="form-group">
                        <label for="academical_directory" class="control-label col-md-4">
                  ...
                  <fieldset>
                        ...
                        <div class="form-group">
                              <label for="addressCity" class="control-label col-md-4"> 
