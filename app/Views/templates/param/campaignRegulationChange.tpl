<div class="container">
    ...
    <h2>{t}Création/modification d'une réglementation associée à la campagne {/t}{$campaign.campaign_name}</h2>
    <div class="row">
        <div class="col-8">
            <form class="form-horizontal " id="campaignRegulationChange" method="post" action="campaignRegulationWrite">
                ...
                <div class="row">
                    <label for="authorization_number" class="form-label col-4 lexical" data-lexical="authorization"> {t}N° d'autorisation :{/t}</label>
                    <div class="col-8">
                        <input id="authorization_number" type="text" class="form-control" name="authorization_number" value="{$data.authorization_number}">
                    </div>
                </div>
                <div class="row">
                    <label for="authorization_date" class="form-label col-4"> {t}Date d'autorisation :{/t}</label>
                    <div class="col-8">
