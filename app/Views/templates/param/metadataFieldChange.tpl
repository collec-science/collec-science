...
<div class="container">
    ...
    <form class="form-horizontal " id="metadataField" method="post" action="metadataFieldWrite">
        ...
        <div class="row">
            ...
            <div class="col-8">
                <input id="name" type="text" class="form-control" name="name" value="{$data.name}" pattern="[a-z0-9_]*" title="{t}Uniquement des minuscules (sans accents), des chiffres, ou le caractère _{/t}" required>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row" id="multipleGroup">
            ...
            <div class="col-8">
                <input class="multiple" type="radio" name="multiple" id="multipleNo" {if $data.multiple !='yes' }checked{/if} value="no">&nbsp;{t}non{/t}
            ...
            <div class="col-8">
                <table id="multiples">
                    ...
                    <tr id="multiple{$numligne}" data-ligne="{$numligne}">
                        <td>
                            <input type="text" name="choiceList[]" class="form-control choiceList" value="{$choice}" data-ligne="{$numligne}">
                        </td>
                        <td class="center">
                            <img class="removeMultiple" src="display/images/remove-red-24.png" height="25" data-ligne="{$numligne}">
                        </td>
                    </tr>
                    {$numligne = $numligne + 1}
                    {/foreach}
                    <tr id="multiple{$numligne}" data-ligne="{$numligne}">
                        <td>
                            <input type="text" name="choiceList[]" class="form-control choiceList" value="" data-ligne="{$numligne}">
                        </td>
                        <td class="center">
                            <img class="removeMultiple" src="display/images/remove-red-24.png" height="25" data-ligne="{$numligne}">
                        </td>
        ...
        <div class="row">
            ...
            <div class="col-8">
                <input type="radio" name="isSearchable" id="isSearchable0" {if $data.isSearchable !="yes" }checked{/if} value="no">
                {t}non{/t}
                <input type="radio" name="isSearchable" id="isSearchable1" {if $data.isSearchable=="yes" }checked{/if} value="yes">&nbsp;{t}oui{/t}
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-8">
                <input type="radio" name="required" id="required0" {if $data.required !="true" }checked{/if} value="false">&nbsp;
                {t}non{/t}
                <input type="radio" name="required" id="required1" {if $data.required=="true" }checked{/if} value="true">&nbsp;{t}oui{/t}
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-8">
                <input type="radio" name="helperChoice" id="helperChoice0" {if $data.helperChoice !="true" }checked{/if} value="false" class="helperChoice">&nbsp;
                {t}non{/t}
