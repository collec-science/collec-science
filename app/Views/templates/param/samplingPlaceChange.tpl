        ...
        <div class="col-md-6">
            <form class="form-horizontal " id="samplingPlaceForm" method="post" action="samplingPlaceWrite">
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <input id="samplingPlaceName" type="text" class="form-control" name="sampling_place_name" value="{$data.sampling_place_name}" autofocus required>
                    </div>
                </div>
                <div class="row">
                    <label for="samplingPlaceCode" class="form-label col-4">{t}Code métier :{/t}</label>
                    <div class="col-8">
                        <input id="samplingPlaceCode" type="text" class="form-control" name="sampling_place_code" value="{$data.sampling_place_code}">
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <input id="wgs84_x" type="text" class="form-control" name="sampling_place_x" value="{$data.sampling_place_x}">
                    </div>
                </div>
                <div class="row">
                    <label for="wgs84_y" class="form-label col-4">{t}Latitude :{/t}</label>
                    <div class="col-8">
                        <input id="wgs84_y" type="text" class="form-control" name="sampling_place_y" value="{$data.sampling_place_y}">
                    </div>
                </div>
                <div class="row">
