    ...
    <form class="form-horizontal protoform" id="collectionForm" method="post" action="index.php">
      ...
      <ul class="nav nav-tabs" id="collectionTab" role="tablist">
        <li class="nav-item active">
          <a class="nav-link collectionTab" id="tabgeneral" data-toggle="tab" role="tab" aria-controls="navgeneral"
        ...
        <li class="nav-item">
          <a class="nav-link collectionTab" id="tabsampletypes" href="#navsampletypes" data-toggle="tab" role="tab"
            aria-controls="navsampletypes" aria-selected="false">
      ...
      <div class="tab-content col-lg-12 form-horizontal" id="tabContent">
        ...
        <div class="tab-pane active in" id="navgeneral" role="tabpanel" aria-labelledby="tabgeneral">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <input id="collectionDisplayname" type="text" class="form-control" name="collection_displayname"
                value="{$data.collection_displayname}">
            </div>
          </div>
          <div class="form-group">
            <label for="collectionDisplayname" class="control-label col-md-4">
              {t}Mots clés, séparés par une virgule :{/t}</label>
            <div class="col-md-8">
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <div class="radio">
                <label>
                  <input type="radio" name="allowed_import_flow" id="aif_1" value="0" {if
                    $data.allowed_import_flow==0}checked{/if}>
                  {t}non{/t}
                </label>
                <label>
                  <input type="radio" name="allowed_import_flow" id="aif_2" value="1" {if
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <div class="radio" id="allowed_export_flow">
                <label>
                  <input type="radio" name="allowed_export_flow" id="aef_1" value="0" {if
                    $data.allowed_export_flow==0}checked{/if}>
                  {t}non{/t}
                </label>
                <label>
                  <input type="radio" name="allowed_export_flow" id="aef_2" value="1" {if
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <div class="radio" id="public_collection">
                <label>
                  <input type="radio" name="public_collection" id="pub1" value="0" {if
                    $data.public_collection==0}checked{/if}>
                  {t}non{/t}
                </label>
                <label>
                  <input type="radio" name="public_collection" id="pub2" value="1" {if
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <div class="radio">
                <label>
                  <input type="radio" name="no_localization" id="no_localization1" value="1" {if
                    $data.no_localization=="1" }checked{/if}>
                  {t}oui{/t}
                </label>
                <label>
                  <input type="radio" name="no_localization" id="no_localization0" value="0" {if
                    $data.no_localization==0}checked{/if}>
                  {t}non{/t}
                </label>
              </div>
            </div>
          ...
          <div class="form-group">
            <label for="external_storage_enabled" class="control-label col-md-4">
              {t}Le stockage de documents attachés aux échantillons est-il possible hors base de données ?{/t}</label>
            <div class="col-md-8">
              <div class="radio">
                <label>
                  <input type="radio" name="external_storage_enabled" id="external_storage_enabled1" value="1" {if
                    $data.external_storage_enabled=="1" }checked{/if}>
                  {t}oui{/t}
                </label>
                <label>
                  <input type="radio" name="external_storage_enabled" id="external_storage_enabled0" value="0" {if
                    $data.external_storage_enabled==0}checked{/if}>
                  {t}non{/t}
                </label>
              </div>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <input id="external_storage_root" type="text" class="form-control" name="external_storage_root"
                value="{$data.external_storage_root}">
            </div>
          </div>
        </div>
        <!--groupes-->
        ...
        <div class="tab-pane fade" id="navsampletypes" role="tabpanel" aria-labelledby="tabsampletypes">
          <div class="form-group">
            <label for="sampletypes" class="control-label col-md-4">
              {t}Types d'échantillons spécifiques de la collection :{/t}</label>
            <div class="col-md-7">
        ...
        <div class="tab-pane fade" id="naveventtypes" role="tabpanel" aria-labelledby="tabeventtypes">
          <div class="form-group">
            <label for="eventtypes" class="control-label col-md-4">
              {t}Types d'événements spécifiques de la collection :{/t}</label>
            <div class="col-md-7">
