...
{/if}
<table id="referentList" class="table table-bordered table-hover datatable display" >
<thead>
<tr>
...
<td>
{if $rights.param == 1}
<a href="referentChange?referent_id={$data[lst].referent_id}">
...
{if $rights.param == 1}
<td class="center">
<a href="referentCopy?referent_id={$data[lst].referent_id}" title="{t}Dupliquer le référent{/t}">
