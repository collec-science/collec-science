...
<div class="container-fluid">
	...
	<form class="form-horizontal" id="labelForm" method="post" action="labelWrite" enctype="multipart/form-data">
		...
		<div class="row">
			...
			<div class="col-8">
				<textarea id="label_xsl" class="form-control textarea-edit" rows="20" required>{$data.label_xsl}</textarea>
			</div>
		</div>
		...
		<fieldset>
			...
			<div class="row">
				...
				<div class="col-8">
					<input id="radical" type="text" class="form-control" name="radical" value="{$opticals[0].radical}">
				</div>
			</div>
			<div class="row">
				...
				<div class="col-8">
					<input id="optical_content" type="text" class="form-control" name="optical_content" value="{$opticals[0].optical_content}" required>
				</div>
			</div>
		</fieldset>
		<fieldset>
			<legend>
				<label for="optical2Enabled" class="form-check-label">
					{t}Second code optique : activer{/t}
				</label>
				<input id="optical2Enabled" name="optical2enabled" value="1" type="checkbox" class="form-check-input" {if $opticals[1].label_optical_id>
				0}checked{/if}>
			</legend>
			<input type="hidden" name="label_optical_id2" value="{$opticals[1].label_optical_id}">
			<div id="optical2" disabled>
				<div class="row">
				...
				<div class="row">
					...
					<div class="col-8">
						<input id="radical2" type="text" class="form-control" name="radical2" value="{$opticals[1].radical}">
					</div>
				</div>
				<div class="row">
					...
					<div class="col-8">
						<input id="optical_content2" type="text" class="form-control" name="optical_content2" value="{$opticals[1].optical_content}">
					</div>
				</div>
			</div>
		</fieldset>
