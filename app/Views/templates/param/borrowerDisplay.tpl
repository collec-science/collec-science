...
<div class="row">
    ...
    &nbsp;
    <a href="borrowerChange?borrower_id={$data.borrower_id}">
        ...
        <tbody>
            {foreach $borrowings as $borrowing}
                <tr>
                    ...
                    <td>
                        <a href="{if $borrowing.object_type=='sample'}sampleDisplay{else}containerDisplay{/if}?uid={$borrowing.uid}">
        ...
        <tbody>
            {foreach $subsamples as $subsample}
                <tr>
                    ...
                    <td>
                        <a href="sampleDisplay?uid={$subsample.uid}">
