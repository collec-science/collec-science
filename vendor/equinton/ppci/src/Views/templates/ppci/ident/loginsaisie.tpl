				...
				<div class="row">
					...
					<div class="col-8">
						<div class="form-check form-check-inline">
							<input type="radio" id="actif1" class="form-check-input" name="actif" value="1" {if $data.actif==1}checked{/if}>
							<label class="form-check-label" for="actif1">
								{t}oui{/t}
							</label>
						</div>
						<div class="form-check form-check-inline">
							<input type="radio" id="actif0" class="form-check-input" name="actif" value="0" {if $data.actif==0}checked{/if}>
