...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="row mb-6">
            <label for="printer_name"  class="form-label col-md-4"><span class="red">*</span> {t}Nom usuel :{/t}</label>
            <div class="col-md-8">
                <input id="printer_name" type="text" class="form-control" name="printer_name" value="{$data.printer_name}" autofocus required>
            </div>
        </div>
        <div class="row mb-6">
            <label for="printer_queue"  class="form-label col-md-4"><span class="red">*</span> {t}Nom de la file d'impression (nom technique) :{/t}</label>
            <div class="col-md-8">
                <input id="printer_queue" type="text" class="form-control" name="printer_queue" value="{$data.printer_queue}" required>
            </div>
        </div>
        <div class="row mb-6">
            <label for="printer_server"  class="form-label col-md-4">{t}Nom du serveur (si impression distante) :{/t}</label>
            <div class="col-md-8">
                <input id="printer_server" type="text" class="form-control" name="printer_server" value="{$data.printer_server}" >
            </div>
        </div>
        <div class="row mb-6">
            <label for="printer_user"  class="form-label col-md-4">{t}Nom de l'utilisateur pour l'identification (si requis) :{/t}</label>
            <div class="col-md-8">
                <input id="printer_user" type="text" class="form-control" name="printer_user" value="{$data.printer_user}" >
            </div>
        </div>
         <div class="row mb-6">
            <label for="printer_comment"  class="form-label col-md-4">{t}Commentaire :{/t}</label>
            <div class="col-md-8">
