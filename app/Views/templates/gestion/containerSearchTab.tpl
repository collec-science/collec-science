	...
	<form class="" id="container_search" action="{if strlen($moduleBase)>0}{$moduleBase}{else}container{/if}{if strlen($action)>0}{$action}{else}List{/if}" method="GET">
		...
		<div class="tab-content form-horizontal" id="search-tabContent">
			<div class="tab-pane active in" id="navsearch-uid" role="tabpanel" aria-labelledby="tabsearch-uid">
				<div class="row">
					<div class="row">
						...
						<label for="name" class="col-4 offset-md-1 text-end form-label">
				...
				<div class="row">
					<div class="row">
						<label for="container_family_id" class="col-2 text-end form-label lexical" data-lexical="container_family">{t}Famille :{/t}</label>
						<div class="col-4">
						...
						<label for="container_type_id" class="col-2 text-end form-label lexical" data-lexical="container_type">{t}Type :{/t}</label>
						<div class="col-4">
				...
				<div class="row">
					<div class="row">
						<label for="object_status_id" class="col-2 text-end form-label lexical" data-lexical="status">{t}Statut :{/t}</label>
						<div class="col-2">
						...
						<label for="trashed" class="col-4 text-end form-label lexical" data-lexical="trashed" title="{t}Échantillons mis à la corbeille{/t}">{t}En attente de suppression :{/t}</label>
						<div class="col-2">
			...
			<div class="tab-pane fade" id="navsearch-others" role="tabpanel" aria-labelledby="tabsearch-others">
				<div class="row">
					<div class="row">
						<label for="collection_id" class="col-3 text-end form-label">{t}Collection :{/t}</label>
						<div class="col-6">
				...
				<div class="row">
					<div class="row">
						<label for="movement_reason_id" class="col-3 text-end form-label">{t}Motif de déstockage :{/t}</label>
						<div class="col-6">
				...
				<div class="row">
					<div class="row">
						<label for="date_from" class="col-3 text-end form-label">{t}du :{/t}</label>
						<div class="col-auto">
							<input class="datepicker form-control" id="date_from" name="date_from" value="{$containerSearch.date_from}">
						</div>
						<label for="date_to" class="col-auto text-end form-label">{t}au :{/t}</label>
						<div class="col-auto">
