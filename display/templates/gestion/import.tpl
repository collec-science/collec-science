...
<li><b>sampling_place</b> : le nom de l'endroit où l'échantillon a été créé</li>
...
<li><b>sample_metadata_json</b> : les métadonnées rattachées à l'échantillon (en json)</li>
