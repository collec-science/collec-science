...
<div class="row">
  <div class="col-md-8">
    <form class="form-horizontal " id="campaignRegulationChange" method="post" action="campaignRegulationWrite">
      ...
      <div class="row mb-6">
        <label for="referent_id" class="form-label col-md-4">{t}Réglementation :{/t}</label>
        <div class="col-md-8">
      ...
      <div class="row mb-6">
        <label for="authorization_number"  class="form-label col-md-4 lexical" data-lexical="authorization"> {t}N° d'autorisation :{/t}</label>
        <div class="col-md-8">
          <input id="authorization_number" type="text" class="form-control" name="authorization_number" value="{$data.authorization_number}">
        </div>
      </div>
      <div class="row mb-6">
        <label for="authorization_date"  class="form-label col-md-4"> {t}Date d'autorisation :{/t}</label>
        <div class="col-md-8">
