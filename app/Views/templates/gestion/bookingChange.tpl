...
<div class="row mb-6">
<label for="date_from" class="form-label col-md-4"><span class="red">*</span> {t}Du :{/t}</label>
<div class="col-md-8">
...
<div class="row mb-6">
<label for="date_to" class="form-label col-md-4"><span class="red">*</span> {t}Au :{/t}</label>
<div class="col-md-8">
...
<div class="row mb-6">
<label for="booking_date" class="form-label col-md-4">{t}Date de la réservation :{/t}</label>
<div class="col-md-8">
...
<div class="row mb-6">
<label for="booking_login" class="form-label col-md-4">{t}Réservation effectuée par :{/t}</label>
<div class="col-md-8">
...
<div class="row mb-6">
<label for="booking_comment" class="form-label col-md-4">{t}Commentaire :{/t}</label>
<div class="col-md-8">
